...
#諸変数の定義
num_classes = 5 #クラス数
model_path = './model/incptionv3_weights_real_simulation1800.h5' #評価するモデルのパス
test_data_path = 'real_simulation1800_test.npz'   #テストデータのパス
save_name = 'incv3_real_simulation1800_confusion_matrix' #混合行列保存用のファイル名
num_test = 1110 #テストデータの枚数
