...
train_data_path = 'simulation_train.npz' #訓練データのパス
test_data_path = 'simulation_test.npz'   #テストデータのパス
num_test = 600 #テストデータの枚数
full_con_ep = 15 #全結合層学習のエポック数
model_save_path = './model/incptionv3_weights_simulation.h5'
