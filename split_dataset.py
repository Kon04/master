...
def main():
    #諸変数の定義
    original_dir = "C:/Kon/master_reserch/datasets/simulation/simulation450" #分割元のデータセットフォルダーのパス
    base_dir = "C:/Kon/master_reserch/datasets/simulation450" #分割後のデータを格納するフォルダのパス
